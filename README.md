...
```PowerShell
java -cp target/bhagikafkaapp-1.0-SNAPSHOT-jar-with-dependencies.jar edu.nwmsu.csis.bhagikafka.CustomConsumer
```
...
```PowerShell
java -cp target/bhagikafkaapp-1.0-SNAPSHOT-jar-with-dependencies.jar edu.nwmsu.csis.bhagikafka.CustomProducer
```
